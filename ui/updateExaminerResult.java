 ...
 * @author tommy
 */
public class updateExaminerResult extends javax.swing.JPanel {
    ...
    private ArrayList<examinerResult> currentResultList = new ArrayList<examinerResult>();
    public updateExaminerResult(String resultID, JFrame frm, examiner examiner) {
        initComponents();
        this.resultID = resultID;
        this.examiner = examiner;
        ArrayList<String> registeredSubjectList = new ArrayList<String>();
        currentResultList = maintainExamSys.getExaminerResultByResultID(resultID);
        for(int i=0;i<currentResultList.size();i++){
            String subjectName = maintainExamSys.getSelectedSubject(currentResultList.get(i).getSubjectID()).getSubjectName();
            registeredSubjectList.add(subjectName);
        }
    ...
    private void jbt_createExaminerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbt_createExaminerActionPerformed
        ...
        text= maintainExamSys.updateExaminerResult(examinerResult);
        }   
        ...
        text = maintainExamSys.updateExaminerResult(examinerResult2);
        }
        ...
        text = maintainExamSys.updateExaminerResult(examinerResult3);
        }
        ...
        text = maintainExamSys.updateExaminerResult(examinerResult4);
        }
        ...
        text = maintainExamSys.updateExaminerResult(examinerResult5);
        }
        
        
        if(text.equalsIgnoreCase("PASS"))
            JOptionPane.showMessageDialog(null, "Update result success!", "REGISTER SUBJECT SUCCESS", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
    ...
    public double getCGPA(){
        double cgpa = 0;
        int totalSemesterCount = maintainExamSys.getExaminerResultNotByResultID(resultID).size()/5;
        if(totalSemesterCount==0)
            ...
            System.out.println("totalSemesterCount: "+totalSemesterCount);
        }
        return cgpa;
    }
    public void setResultID(examinerResult examinerResult){
        //check current semester
         examinerResult.setResultID(resultID);
    }
